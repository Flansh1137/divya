...
import { AiOutlineRight } from 'react-icons/ai'; // ✅ Correct icon import
                    ...
                    <div className="contact-info lg:col-span-2 lg:pr-[15px]">
                        ...
                        <ul className="text-[14px] leading-[27px] text-secondary pt-6">
                            ...
                            <li className="pb-[15px]">
                                <Link href={contactItems[0]?.contactNumberPath}>
                                    {contactItems[0]?.contactNumber}
                                </Link>
                            </li>
                            <li>
                                <Link href={contactItems[0]?.contactEmailPath}>
                        ...
                        <div className="button-wrap pt-[95px]">
                            <Link href="/contact">
                                <div className="inline-flex items-center text-[14px] leading-[30px] p-[11px_32px] transition duration-[0.4s] border border-[#969696] uppercase hover:border-black hover:bg-black hover:text-white cursor-pointer">
